...
var _rc4_crypt = Module['_rc4_crypt'] = makeInvalidEarlyAccess('_rc4_crypt');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['rc4_crypt'] != 'undefined', 'missing Wasm export: rc4_crypt');
  _rc4_crypt = Module['_rc4_crypt'] = createExportWrapper('rc4_crypt', 5);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createRC4Module;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createRC4Module;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createRC4Module);
